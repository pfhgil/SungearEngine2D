...
public class TransformComponent extends Component implements NonDuplicated
{
    ...
    protected transient Vector3f lastPosition = new Vector3f();
    protected transient Vector3f lastRotation = new Vector3f();
    protected transient Vector3f lastScale = new Vector3f(1.0f);
    // ------------------------------------------------------
