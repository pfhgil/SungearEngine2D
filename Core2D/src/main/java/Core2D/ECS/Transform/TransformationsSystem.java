...
public class TransformationsSystem extends System
{
    ...
    public void updateLastPosition(TransformComponent transformComponent)
    {
    ...
    public void updateLastRotation(TransformComponent transformComponent)
    {
        if(transformComponent == null || !transformComponent.active) return;
    ...
    public void updateLastScale(TransformComponent transformComponent)
    {
        if(transformComponent == null || !transformComponent.active) return;
