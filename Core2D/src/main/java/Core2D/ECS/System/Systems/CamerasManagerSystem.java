...
public class CamerasManagerSystem extends System implements NonRemovable
{
    ...
    public void update(ComponentsQuery componentsQuery)
    {
        ...
        if (camera2DComponent != null) {
            ...
            updateViewMatrix(componentsQuery);
    ...
    private void updateViewMatrix(ComponentsQuery componentsQuery)
    {
        ...
        if(transformComponent != null) {
            ...
            float rotation = MatrixUtils.getRotation(transformComponent.modelMatrix);
