...
public class PrimitivesSystem extends System
{
    ...
    {
        List<PrimitiveComponent> primitiveComponents = componentsQuery.getAllComponents(PrimitiveComponent.class);
    ...
    {
        //Log.CurrentSession.println("updating: " + circleComponent + ", " + circleComponent.active + ", " + circleComponent.entity.active, Log.MessageType.WARNING);
