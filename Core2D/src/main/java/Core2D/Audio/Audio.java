 ...
 */
    ...
    {
        if(playing || paused) {
            return OpenAL.alCall((params) -> AL11.alGetSourcef(source, AL11.AL_SEC_OFFSET), Float.class);
        } else {
    ...
    {
        this.cyclic = cyclic;
        OpenAL.alCall((params) -> AL10.alSourcei(source, AL10.AL_LOOPING, cyclic ? AL10.AL_TRUE : AL10.AL_FALSE));
    }
}
