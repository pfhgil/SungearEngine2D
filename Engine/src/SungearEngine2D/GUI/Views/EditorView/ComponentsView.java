...
import Core2D.ECS.Audio.AudioType;
import Core2D.ECS.Camera.CameraComponent;
import Core2D.ECS.Mesh.MeshComponent;
import Core2D.ECS.Deprecated.ParticlesSystemComponent;
...
public class ComponentsView extends View
{
                ...
                switch (componentName) {
                    case "TransformComponent" -> {
                        ...
                        float[] centre = new float[]{
                                transformComponent.center.x,
                                transformComponent.center.y,
                                transformComponent.center.z
                        };

                        if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("Position", pos))) {
                            transformComponent.position.set(pos);
                        }
                        if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("Rotation", rotation))) {
                            transformComponent.rotation.set(rotation);
                        }
                        if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("Scale", scale, 0.01f))) {
                            transformComponent.scale.set(scale);
                        }
                        if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("Centre", centre, 0.01f))) {
                            transformComponent.center.set(centre);
                        }
                    }
                    case "MeshComponent" -> {
                    ...
                    case "LineComponent" -> {
                        ...
                        ImGui.pushID("LineOffsetDragFloat_" + i);
                        {
                            float[] offset = new float[] {
                                    lineComponent.linesData[0].offset.x,
                                    lineComponent.linesData[0].offset.y,
                                    lineComponent.linesData[0].offset.z
                            };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat2("Offset", offset))) {
                                lineComponent.linesData[0].offset.set(offset[0], offset[1], offset[2]);
                            }
                        }
                        ImGui.popID();
                        ...
                        ImGui.pushID("LineStartDragFloat_" + i);
                        {
                            float[] start = new float[] {
                                    lineComponent.linesData[0].start.x,
                                    lineComponent.linesData[0].start.y,
                                    lineComponent.linesData[0].start.z
                            };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("Start", start))) {
                                lineComponent.linesData[0].start.set(start[0], start[1], start[2]);
                            }
                        }
                        ImGui.popID();
                        ...
                        {
                            float[] end = new float[] {
                                    lineComponent.linesData[0].end.x,
                                    lineComponent.linesData[0].end.y,
                                    lineComponent.linesData[0].end.z
                            };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("End", end))) {
                                lineComponent.linesData[0].end.set(end[0], end[1], end[2]);
                            }
                        }
                        ImGui.popID();
                        ...
                        {
                            float[] color = new float[] { lineComponent.linesData[0].color.x, lineComponent.linesData[0].color.y,
                                    lineComponent.linesData[0].color.z, lineComponent.linesData[0].color.w };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.colorEdit4("Color", color))) {
                                lineComponent.linesData[0].color.set(color[0], color[1], color[2], color[3]);
                            }
                        }
                        ImGui.popID();
                    ...
                    case "BoxComponent" -> {
                        ...
                        {
                            float[] offset = new float[] {
                                    boxComponent.offset.x,
                                    boxComponent.offset.y,
                                    boxComponent.offset.z
                            };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("Offset", offset))) {
                                boxComponent.offset.set(new Vector3f(offset[0], offset[1], offset[2]));
                            }
                        }
                        ImGui.popID();
                        ...
                        {
                            float[] size = new float[] { boxComponent.size.x, boxComponent.size.y };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat2("Size", size))) {
                                boxComponent.size.set(new Vector2f(size[0], size[1]));
                            }
                        }
                        ImGui.popID();
                        ...
                        {
                            float[] lineWidth = new float[] { boxComponent.linesWidth };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat("Lines width", lineWidth, 0.1f, 1.0f, 20.0f))) {
                                ...
                                boxComponent.linesWidth = lineWidth[0];
                            }
                        }
                        ImGui.popID();
                        ...
                        {
                            float[] color = new float[] { boxComponent.color.x, boxComponent.color.y,
                                    boxComponent.color.z, boxComponent.color.w };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.colorEdit4("Color", color))) {
                                boxComponent.color.set(new Vector4f(color[0], color[1], color[2], color[3]));
                            }
                        }
                        ImGui.popID();
                    ...
                    case "CircleComponent" -> {
                        ...
                        {
                            float[] offset = new float[] {
                                    circleComponent.offset.x,
                                    circleComponent.offset.y,
                                    circleComponent.offset.z
                            };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("Offset", offset))) {
                                circleComponent.offset.set(new Vector3f(offset[0], offset[1], offset[2]));
                            }
                        }
                        ImGui.popID();
                        ...
                        {
                            float[] radius = new float[] { circleComponent.radius };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat("Radius", radius, 0.1f))) {
                                circleComponent.radius = radius[0];
                            }
                        }
                        ImGui.popID();
                        ...
                        {
                            float[] lineWidth = new float[] { circleComponent.linesWidth };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat("Lines width", lineWidth, 0.1f, 1.0f, 20.0f))) {
                                lineWidth[0] = Math.clamp(1.0f, 20.0f, lineWidth[0]);
                                circleComponent.linesWidth = lineWidth[0];
                            }
                        }
                        ImGui.popID();
                        ...
                        {
                            float[] color = new float[] { circleComponent.color.x, circleComponent.color.y,
                                    circleComponent.color.z, circleComponent.color.w };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.colorEdit4("Color", color))) {
                                circleComponent.color.set(new Vector4f(color[0], color[1], color[2], color[3]));
                            }
                        }
                        ImGui.popID();
                        ...
                        {
                            int[] angleIncrement = new int[] { circleComponent.angleIncrement };
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragInt("Angle increment", angleIncrement, 1, 1, 360))) {
                                ...
                                circleComponent.angleIncrement = angleIncrement[0];
                            }
                        }
                        ImGui.popID();
                    ...
                    case "CameraComponent" -> {
                        ...
                        if (ImGui.treeNode("Transformations")) {
                            ...
                            float[] rotation = new float[]{
                                    cameraComponent.rotation.x,
                                    cameraComponent.rotation.y,
                                    cameraComponent.rotation.z
                            };
                            float[] scale = new float[]{
                                    cameraComponent.scale.x,
                                    cameraComponent.scale.y,
                                    cameraComponent.scale.z
                            };

                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("Position", pos))) {
                                cameraComponent.position.set(pos);
                            }
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.dragFloat3("Rotation", rotation))) {
                            ...
                            ImGui.pushID("CameraViewMode");
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.beginCombo("View mode", cameraComponent.viewMode.toString()))) {
                        ...
                        if (ImGui.treeNode("Rendering")) {
                            ...
                            if (ImGuiUtils.imCallWBorder(func -> ImGui.checkbox("Render", cameraComponent.render))) {
                                cameraComponent.render = !cameraComponent.render;
                            }
                            ImGui.popID();

                            drawShaderDefaultBooleanDefines(cameraComponent.postprocessingDefaultShader);
                            ...
                            if (ImGui.treeNode("Postprocessing")) {
                                if (ImGuiUtils.arrowButton("Add PP layer...", "AddPPLayerButton_" + i, true)) {
                                    ...
                                    if (ImGuiUtils.imCallWBorder(func -> ImGui.beginListBox("", 150.0f, 75.0f))) {
                                        for (Layer layer : currentSceneManager.getCurrentScene2D().getLayering().getLayers()) {
                                            if (!ECSWorld.getCurrentECSWorld().camerasManagerSystem.isPostprocessingLayerExists(cameraComponent, layer)) {
                                                ImGui.pushID("PPLayerToAdd_" + k + "_" + i);
                                                if (ImGui.selectable(layer.getName())) {
                                                    cameraComponent.postprocessingLayers.add(new PostprocessingLayer(layer));
                                ...
                                k = 0;
                                Iterator<PostprocessingLayer> ppCamLayersIterator = cameraComponent.postprocessingLayers.listIterator();
                                    ...
                                    if (ImGui.treeNode("Postprocessing layer \"" + (ppLayer.getEntitiesLayerToRender() != null ? ppLayer.getEntitiesLayerToRender().getName() + "\"" : "unknown\""))) {
                                        ...
                                        if (shaderEditButtonPressed[0]) {
                                            ShadersEditorView.ShaderEditorWindow newShaderEditorWindow = new ShadersEditorView.ShaderEditorWindow(
                                                    ppLayer.getShader(),
                                                    new ComponentHandler(cameraComponent.entity.getLayer().getID(),
                                                            cameraComponent.entity.ID, cameraComponent.ID));
                                        ...
                                        if (ImGui.button("View...")) {
                                            if (!ViewsManager.isFBOViewExists("PPLayerView_" + i + "_" + k)) {
                                                ViewsManager.getFBOViews().add(new GameView("PPLayer \"" + ppLayer.getEntitiesLayerToRenderName() + "\"", "PPLayerView_" + i + "_" + k,
                                                        ppLayer.getFrameBuffer().getTextureHandler(), true, ppLayer, new ComponentHandler(cameraComponent.entity.getLayer().getID(), cameraComponent.entity.ID, cameraComponent.ID)));
                                            } else {
                                                GameView gameView = ViewsManager.getFBOView("PPLayerView_" + i + "_" + k);
                                                gameView.setPostprocessingLayer(ppLayer, new ComponentHandler(cameraComponent.entity.getLayer().getID(), cameraComponent.entity.ID, cameraComponent.ID));
                                            }
                                        }
                                        ...
                                        if (cameraComponent.postprocessingLayers.size() > 1 && k != cameraComponent.postprocessingLayers.size() - 1) {
                                            ImGui.separator();
                                        }
                ...
                if(ImGui.beginListBox("")) {
                    ...
                    try {
                        ...
                        if(ImGui.selectable("Camera2DComponent")) {
                            inspectingEntity.addComponent(new CameraComponent());
                            action = "";
                        }
    ...
    private void drawShaderDefaultBooleanDefines(Shader shader)
    {
        ...
        if(flipTexturesYDefine != null) {
            ...
            if (ImGuiUtils.imCallWBorder(func -> ImGui.checkbox("Flip textures Y", flipTexturesYDefine.value == 1))) {
