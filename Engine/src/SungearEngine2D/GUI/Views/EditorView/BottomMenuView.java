...
public class BottomMenuView
{
    ...
    public void draw()
    {
        ...
        if(tasksList.size() > 1) {
            ...
            ImGui.sameLine();
            Vector2f collapseIconSize = new Vector2f(Resources.Textures.Icons.collapseIcon.getWidth(), Resources.Textures.Icons.collapseIcon.getHeight());
    ...
    public void showProgressBar(Task task)
    {
        ...
        Vector2f xIconSize = new Vector2f(Resources.Textures.Icons.xIcon.getWidth() - 1, Resources.Textures.Icons.xIcon.getHeight() - 1);
